...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        Tourism is owned and managed by Tourism. In Pvt. Ltd., a leading brand
        in web designing services and e-commerce solutions. Tourism .In Pvt.
        ...
        Commendable success rate of other portals managed by Tourism is a live
